...
describe('mapPhoneNumberOutOf', () => {
    ...
    describe('valid value', () => {
        ...
        it.each([
            ['07 82 13 77 21', '0782137721'],
            ['07 82 13 77 21', '+33782137721'],
            ['07 82 13 77 21', '0782 13 772 1'],
            ['07 82 13 77 21', '+33 0782 13 7721'],
            ['06 89 22 11 99', '+33689221 199'],
            ['06 08 27 18 73', '+330608271873'],
